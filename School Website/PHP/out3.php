...
$query = "SELECT * FROM student WHERE ID='79' ";
...
echo '<table border="0" cellspacing="2" cellpadding="2"> 
      <tr> 
          ...
          <td> <font face="Arial">Building Address</font> </td> 
          <td> <font face="Arial">Street Address</font> </td> 
          <td> <font face="Arial">City</font> </td> 
          <td> <font face="Arial">Tel Number</font> </td>
          <td> <font face="Arial">Class</font> </td> 
          <td> <font face="Arial">Email</font> </td> 
          <td> <font face="Arial">UserName</font> </td> 
          <td> <font face="Arial">Password</font> </td> 
          <td> <font face="Arial">Absence History</font> </td> 
          <td> <font face="Arial">Behaviour History</font> </td>
          <td> <font face="Arial">Grades</font> </td>
          <td> <font face="Arial">Weekly Schedule</font> </td> 
          <td> <font face="Arial">Home works</font> </td>       
      </tr>';
...
if ($result = $mysqli->query($query)) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<tr> 
                  ...
                  <td><a href="../Grade9.pdf">'.$field16name.'</a></td>
                  <td><a href="../Homework Grade 9.pdf">'.$field17name.'</a></td>
              </tr>';
    }
    $result->free();
} 
